...
namespace UnityLauncherProTools
{
    public class InitializeProject : EditorWindow
    {
        ...
        static string[] blackListedPackages = new string[] { "com.unity.modules.unityanalytics", "com.unity.modules.director", "com.unity.collab-proxy", "com.unity.ide.rider", "com.unity.test-framework", "com.unity.timeline", "com.unity.visualscripting" };
